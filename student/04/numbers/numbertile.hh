...
public:
    ...
    * */
    ...
    NumberTile(int value, int x, int y,  std::vector<std::vector<NumberTile>> *board);
    ...
    bool setValue(int value, bool isInitializing = false);

    friend std::ostream& operator << (std::ostream &out, NumberTile &tile);
private:
    ...
    int x_;
    int y_;
    std::vector<std::vector<NumberTile>>* parent_;
};
